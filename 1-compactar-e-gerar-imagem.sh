...
echo " "
echo "Mas se o conteiner foi criado via Docker Compose, logo a definição de bind de porta é diferente, então para testar: "
echo " "
echo "no browser do host http://0.0.0.0:8080"
echo " "